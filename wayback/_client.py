    ...
    def search(self, url, *, match_type=None, limit=1000, offset=None,
        ...
        * SURT implementation: https://github.com/internetarchive/surt
        ...
        query_args = {'url': url, 'matchType': match_type, 'limit': limit,
                      ...
                      'to': to_date, 'filter': filter_field,          # filter_field should be a list
        ...
        for key, value in query_args.items():
            if value is not None:
                if isinstance(value, str):
                    query[key] = value
                elif isinstance(value, list) and key == 'filter':      # Handle 'filter' field as list
                    query[key] = value                                 # Assign the list to the 'filter' key
